...
<head>
    ...
    <title>Nested If pada PHP</title>
</head>
<body style="text-align : center ;margin-top : 100px;">
    <form action="nestedif.php" method="POST">
    ...
    Masukkan Jumlah Kehadiran = <input type="integer" name="jumlah" placeholder="0-12"><br/>
